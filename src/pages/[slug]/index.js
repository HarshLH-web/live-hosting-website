...
export async function getStaticPaths() {
    try {
      ...
      const res = await axios.get("https://webpanel.store/api/live-hosting-blogs/selected-fields");
...
export async function getStaticProps({ params }) {
    ...
    try {
        ...
        const response = await axios.get(`https://webpanel.store/api/live-hosting-blogs/${slug}`);
        const { tableOfContents, contentBlocks } = processBlogPageContent(response.data.content);
